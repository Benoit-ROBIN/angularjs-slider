        ...
        .factory('RzSlider', ['$timeout', '$document', '$window', '$compile', 'RzSliderOptions', 'rzThrottle', function ($timeout, $document, $window, $compile, RzSliderOptions, rzThrottle) {
            ...
            Slider.prototype = {
                ...
                getEventNames: function (event) {
                    ...
                    } else if (typeof MSApp != "undefined") { //WINDOWS
                        eventNames.moveEvent = 'pointermove ';
                        eventNames.endEvent = 'pointerup ';
                    } else {
                ...
                bindEvents: function () {
                    ...
                    /*************** WINDOWS ***************/
                    if (!this.options.onlyBindHandles) {
                        this.selBar.on('pointerdown ', angular.bind(this, barStart, null, barTracking));
                        this.selBar.on('pointerdown ', angular.bind(this, barMove, this.selBar));
                    }
                    if (this.options.draggableRangeOnly) {
                        this.minH.on('pointerdown ', angular.bind(this, barStart, null, barTracking));
                        this.maxH.on('pointerdown ', angular.bind(this, barStart, null, barTracking));
                    } else {
                        this.minH.on('pointerdown ', angular.bind(this, this.onStart, this.minH, 'lowValue'));
                        if (this.range) {
                            this.maxH.on('pointerdown ', angular.bind(this, this.onStart, this.maxH, 'highValue'));
                        }
                        if (!this.options.onlyBindHandles) {
                            this.fullBar.on('pointerdown ', angular.bind(this, this.onStart, null, null));
                            this.fullBar.on('pointerdown ', angular.bind(this, this.onMove, this.fullBar));
                            this.ticks.on('pointerdown ', angular.bind(this, this.onStart, null, null));
                            this.ticks.on('pointerdown ', angular.bind(this, this.onTickClick, this.ticks));
                        }
                    }
                    /***************************************/
